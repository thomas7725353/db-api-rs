...
('demo_item_qb_list', '/demo/items/qb-list', 'Demo Item QueryBuilder List', 'QueryBuilder 列表接口，支持 keyword/status 过滤、limit/offset 分页，并返回 total', '[{"name":"keyword","type":"string"},{"name":"status","type":"string"},{"name":"limit","type":"bigint"},{"name":"offset","type":"bigint"}]', 1, 'local_sqlite_demo', 0, 'demo_crud_group', NULL, NULL, datetime('now', 'localtime'), datetime('now', 'localtime'), 'application/x-www-form-urlencoded', 0, NULL);
