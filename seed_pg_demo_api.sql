...
VALUES
('pg_demo_item_create', '/pg/demo/items/create', 'POST', 'PG 创建 Demo Item', 'POST name/status/note 创建 PostgreSQL 记录', '[{"name":"name","type":"string"},{"name":"status","type":"string"},{"name":"note","type":"string"}]', 1, 'postgres_demo', 1, 'pg_crud_group', NULL, NULL, datetime('now', 'localtime'), datetime('now', 'localtime'), 'application/x-www-form-urlencoded', 0, NULL),
('pg_demo_item_get', '/pg/demo/items/get', 'GET', 'PG 查询 Demo Item', '按 id 查询 PostgreSQL 单条记录', '[{"name":"id","type":"bigint"}]', 1, 'postgres_demo', 1, 'pg_crud_group', NULL, NULL, datetime('now', 'localtime'), datetime('now', 'localtime'), 'application/x-www-form-urlencoded', 0, NULL),
('pg_demo_item_update', '/pg/demo/items/update', 'PATCH', 'PG 更新 Demo Item', '按 id 更新 PostgreSQL name/status/note', '[{"name":"id","type":"bigint"},{"name":"name","type":"string"},{"name":"status","type":"string"},{"name":"note","type":"string"}]', 1, 'postgres_demo', 1, 'pg_crud_group', NULL, NULL, datetime('now', 'localtime'), datetime('now', 'localtime'), 'application/x-www-form-urlencoded', 0, NULL),
('pg_demo_item_delete', '/pg/demo/items/delete', 'DELETE', 'PG 删除 Demo Item', '按 id 删除 PostgreSQL 记录', '[{"name":"id","type":"bigint"}]', 1, 'postgres_demo', 1, 'pg_crud_group', NULL, NULL, datetime('now', 'localtime'), datetime('now', 'localtime'), 'application/x-www-form-urlencoded', 0, NULL),
('pg_demo_item_qb_list', '/pg/demo/items/qb-list', 'GET', 'PG Demo Item QueryBuilder List', 'PostgreSQL QueryBuilder 列表接口', '[{"name":"keyword","type":"string"},{"name":"status","type":"string"},{"name":"limit","type":"bigint"},{"name":"offset","type":"bigint"}]', 1, 'postgres_demo', 1, 'pg_crud_group', NULL, NULL, datetime('now', 'localtime'), datetime('now', 'localtime'), 'application/x-www-form-urlencoded', 0, NULL),
('pg_demo_item_view_sql_list', '/pg/demo/items/view-sql-list', 'GET', 'PG Demo Item View SQL List', 'PostgreSQL View SQL 列表接口', '[{"name":"status","type":"string"}]', 1, 'postgres_demo', 1, 'pg_crud_group', NULL, NULL, datetime('now', 'localtime'), datetime('now', 'localtime'), 'application/x-www-form-urlencoded', 0, NULL);
